...
**ipa-acme-companion** is a small modification to acme-companion allowing it to work directly with FreeIPA's bundled CA. By default, upstream acme-companion creates an account key 
